...
describe('Product Model', function () {
    ...
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    _product.id = parseInt(result.id, 10) + 1;
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    it('create method should add a product', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, product.create(_product_Milk)];
                case 1:
                    result = _a.sent();
    ...
    it('index method should return a list/count of product', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('Update method should edit the user details', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, product.update(_product_update)];
                case 1:
                    result = _a.sent();
