...
describe('User Model', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    _user.id = result.id;
                    userID = parseInt(result.id, 10) + 1;
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    it('create method should add a user', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, user.create(_user2)];
                case 1:
                    result = _a.sent();
    ...
    it('index method should return a list/count of users', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('Update method should edit the user details', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, user.update(_user2_update)];
                case 1:
                    result = _a.sent();
